...
url("https://banner2.cleanpng.com/20180324/zpq/kisspng-woman-clip-art-girls-5ab5e34bddcb65.0750230315218696439085.jpg") center;
...
const OuterContainer = styled.div`
  ...
  ${mobile({ position: "relative", top: "0", left: "0" })}
`;
            ...
            onSubmit={async (values, { resetForm }) => {
              ...
              try {
                ...
                const res = await axios.post(
                  `https://joyce-e-shopping.herokuapp.com/api/auth/register`,
                  other
                );
                console.log(res);
                setInfo(
